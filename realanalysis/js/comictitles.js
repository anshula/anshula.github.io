comictitles = [
    ...
    {"title" : "What counts as distance?", "newchapter": "true", "newsubchapter": "Metric Spaces"}, 
    {"title" : "But what's an interesting example of a metric space?"},
    {"title" : "Does teleportation violate notions of distance?"},
    {"title" : "Brainteaser #1"},
    {"title" : "Brainteaser #2"},
    {"title" : "Motivation", "newsubchapter": "Limit Points"},
    {"title" : "What's the difference between 'really close' and 'infinitely close'?"},
    {"title" : "Can we make a set with exactly one limit point at 0?"},
    {"title" : "Brainteaser #1"},
    {"title" : "Brainteaser #2"},
    {"title" : "What are open sets?", "newsubchapter": "Open and Closed Sets"},
    {"title" : "Is the union of open sets always open?"},
    {"title" : "Is there anything interesting about the complement of open sets?"},
    {"title" : "What is the complement of an open set?"},
    {"title" : "An Aside"},
    {"title" : "How can you make an open set closed?"},
    {"title" : "Brainteaser #1"},
    {"title" : "Brainteaser #2"},
    {"title" : "So...what is topology?"},
